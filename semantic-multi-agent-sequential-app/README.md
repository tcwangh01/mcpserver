...
⠹ 審查進行中... 預估階段：人資部門(HRAgent)（已耗時 5 秒）
⠼ 審查進行中... 預估階段：IT部門(ITAgent)（已耗時 18 秒）
⠧ 審查進行中... 預估階段：合規部門(ComplianceAgent)（已耗時 30 秒）
